  ...
  >
    ...
    >
      <template v-if="addLink">
        <span class="nav-link-text" style="font-weight: bold;">
          {{ link.name }} <b class="caret"></b>
        </span>
      </template>
      <template v-else>
        <i :class="link.icon"></i>
        <span  style="font-weight: bold;" class="nav-link-text">{{ link.name }} <b class="caret"></b></span>
      </template>
    </a>
    ...
    >
      ...
      >
        <template v-if="addLink">
          <span style="font-weight: bold;" class="nav-link-text">{{ link.name }}</span>
        </template>
        <template v-else>
          <i :class="link.icon"></i>
          <span style="font-weight: bold;" class="nav-link-text">{{ link.name }}</span>
